...
public class FForEachLowering {
    ...
    public FStatement replace (FForEach forEach, FFunction function) {
        ...
        //condition
        FFunction less = Iterables.getOnlyElement(FBool.INSTANCE.getFunctions(FBinaryOperator.Bool.LESS.identifier));
        ...
        FExpression incCall = new FFunctionCall(new FLocalVariableExpression(counter), inc, ImmutableList.of());
