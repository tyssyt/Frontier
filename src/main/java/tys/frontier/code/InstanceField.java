...
public class InstanceField extends FField {
    ...
    public InstanceField(Position position, FIdentifier identifier, FType type, FClass memberOf, FVisibilityModifier visibility, boolean hasAssignment) {
        super(position, identifier, type, visibility, hasAssignment);
        this.memberOf = memberOf;
        this._this = new FLocalVariable(FIdentifier.THIS, memberOf); //TODO can I just assign the parameter of the accessor to this?
        Pair<FieldAccessor, FieldAccessor> accessors = FieldAccessor.createAccessors(this, ImmutableList.of(FParameter.create(FIdentifier.THIS, memberOf, false)));
